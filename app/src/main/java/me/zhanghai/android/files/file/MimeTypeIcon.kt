...
enum class MimeTypeIcon(val resourceId: Int) {
    ...
    DATABASE(R.drawable.file_database_icon),
...
private val mimeTypeToIconMap = mapOf(
    ...
    "application/vnd.sqlite3" to MimeTypeIcon.DATABASE,
    "application/x-sqlite3" to MimeTypeIcon.DATABASE,
    "application/geopackage+sqlite3" to MimeTypeIcon.DATABASE,
